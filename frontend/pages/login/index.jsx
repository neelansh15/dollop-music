...
export default function Login() {
  ...
  return  <div className="px-15 py-10 pb-20 w-full">
          ...
          <Card>
            ...
            <div className="text-center">
              <button
                ...
                className={"py-2 px-10 m-2 my-3 text-white bg-dark-300 font-semibold text-md rounded-lg" + (hovered ? "" : "bg-dark-100")}
              >
                Login
              </button>
            </div>

            <h1 className="text-xl font-semibold m-2 mb-5 text-gray-400 text-center">OR</h1>

            <h1 className="text-lg font-semibold mb-3">Login with</h1>

            <div className="grid grid-cols-2">
              <div className="col-span-1 bg-dark-300 rounded-lg text-center my-2 mr-2">
                <span class="fa fa-google fa-3x m-3" aria-hidden="true"></span>
              </div>
              
              <div className="col-span-1 bg-dark-300 rounded-lg text-center my-2 ml-2">
                <span class="fa fa-github fa-3x m-3" aria-hidden="true"></span>
              </div>
            </div>
          </Card>
        </div>
